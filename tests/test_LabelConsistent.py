...
adv_ckpt = torch.load('./experiments/BaselineMNISTNetwork_MNIST_Benign_2024-06-13_16:56:34/ckpt_epoch_200_revise.pth')
# import pdb
# import copy
# adv_ckpt_copy = copy.copy(adv_ckpt)
# for new_key in adv_model.state_dict().keys():
#     adv_ckpt_copy[new_key] = adv_ckpt['module.'+new_key]
#     adv_ckpt_copy.pop('module.'+new_key)
    
# torch.save(adv_ckpt_copy, './experiments/BaselineMNISTNetwork_MNIST_Benign_2024-06-13_16:56:34/ckpt_epoch_200_revise.pth')
# pdb.set_trace()
